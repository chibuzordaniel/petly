    ...
    <div className='  bg-white w-[100%] h-[100%]  pb-[227px] dark:bg-[#151D3B] '>
        <div className=' max-w-[1200px] mx-auto'>
            <div className=' pt-[70px]'>
               <h1 className=' lg:pl-0 font-inter font-medium text-[#344062] text-2xl md:pl-10'>Search Results</h1>
            </div>
            {isloading ? (
                 <SkeletonElement/>
            ) : (
                    ...
                    <div className='border lg:w-[327px]  lg:h-[90%] mb-20 '>
                        <div  className=' '>
                            ...
                            <div className=' flex '>
                                ...
                                <h3 className=' pt-7 text-sm pl-4 text-[#AFB6C1] font-inter  font-normal'>Seattle, WA</h3>
                            </div>
                        </div>
                    </div>
                    </div>
        ...
        <div>
            <div className=' pt-14'>
                ...
                <div className=' flex bg-[#F8FAFD] lg:ml-0   w-[327px] h-[51px] mt-[53px] md:ml-10'>
