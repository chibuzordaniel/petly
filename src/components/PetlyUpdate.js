    ...
    <div className='  bg-white w-[100%] h-[100%]  pb-[227px] dark:bg-[#151D3B] '>
        <div className=' max-w-[1200px] mx-auto'>
            <div className=' pt-[70px]'>
               <h1 className=' lg:pl-0 font-inter font-medium text-[#344062] lg:text-2xl sm:pl-10  sm:text-4xl'>Search Results</h1>
            </div>
            {isloading ? (
                 <SkeletonElement/>
            ) : (
        ...
        <div>
            <div className=' pt-14'>
                ...
                <div className=' flex bg-[#F8FAFD] lg:ml-0   w-[327px] h-[51px] mt-[53px] sm:ml-10'>
