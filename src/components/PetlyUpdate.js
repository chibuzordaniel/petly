...
const PetlyUpdate = () => {
  return (
    <div className=' bg-white w-[100%] h-[100%]  pb-[227px]'>
        <div className=' max-w-[1200px] mx-auto'>
            <div className=' pt-[70px]'>
               <h1 className=' font-inter font-medium  text-2xl'>Search Results</h1>
            </div>
            <div className=' grid grid-cols-3 mt-6'>
                <div className='  border w-[327px] h-[100%] pb-7 '>
                    <img  className=' mx-6 mt-5' src={img1} alt='' />
                    <div className=' flex  gap-48 '>
                        <h2 className=' pl-6 font-inter font-medium text-2xl pt-3  text-[#666879] '>Luna</h2>
                        <div className='pt-4'>
                          <img src={img2} alt='' />
                        </div>
                    </div>
        ...
        <div>
            ...
            <div className=' mt-12 grid grid-cols-3'>
                ...
                <div className='  border w-[327px] h-[100%] pb-7 '>
                    <img  className=' mx-6 mt-5' src={img1} alt='' />
                    <div className=' flex  gap-48 '>
                        <h2 className=' pl-6 font-inter font-medium text-2xl pt-3  text-[#666879] '>Bunnahabhain</h2>
                        <div className='pt-4'>
                          <img src={img2} alt='' />
                        </div>
                    </div>
